...
<div id="post-<?php the_ID(); ?>" class="property-cols post-bottom">
	...
	<div class="property-info textcenter">
		<?php
			...
			if( !empty( $post->homeland_garage ) ) : ?>
				<span><i class="fas fa-car"></i><?php printf( esc_html( _n( '%d Garage', '%d Garages', esc_html( $post->homeland_garage ), 'homeland'  ) ), esc_html( $post->homeland_garage ) ); ?></span><?php
			endif;
		?>
	</div>
