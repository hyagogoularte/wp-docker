...
?>
	...
	<section class="theme-pages">
		<div class="inside clearfix">
			...
			<div class="post-col-6 left-container dual-container">		
				<?php get_template_part( 'template-parts/component/property-filter' ); ?>
				<div class="agent-properties property-list dual-property-list clearfix">
					<?php
					...
					<div class="grid cs-style-3">
						<?php
							while ( $wp_query->have_posts() ) : $wp_query->the_post(); 
								get_template_part( 'template-parts/loops/loop', 'property-1col' );
				    	endwhile; 
				    ?>
		    	</div>
				</div>
