<?php
/*
	Template Name: Properties - List Fullwidth
*/
	...
	<section class="theme-pages">
		<div class="inside clearfix">		
			<div class="post-col-12 theme-fullwidth">
				...
				<div class="agent-properties property-list property-list-fullwidth clearfix">
					<?php
					...
					<div class="row grid cs-style-3">
						<?php
							while ( $wp_query->have_posts() ) : $wp_query->the_post(); 
								get_template_part( 'template-parts/loops/loop', 'property-fullwidth' );
					    endwhile; 
					  ?>
			    </div>
				</div>
