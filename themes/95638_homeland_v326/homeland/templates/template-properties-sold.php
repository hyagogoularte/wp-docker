...
*/
	...
	if( 'price' === $homeland_filter_default ) :
		$homeland_sold_order_value = "meta_value_num";
		$homeland_sold_meta_key = "homeland_price";
	elseif( 'title' === $homeland_filter_default ) :
		$homeland_sold_order_value = "title";
		$homeland_sold_meta_key = "";
	elseif( 'rand' === $homeland_filter_default ) :
		$homeland_sold_order_value = "rand";
		$homeland_sold_meta_key = "";
	else :
		$homeland_sold_order_value = "date";
		$homeland_sold_meta_key = "";
	endif;
				...
				<div class="agent-properties property-list clearfix">
					<?php
						...
						$args_wp = array( 
							...
							'meta_key' => $homeland_sold_meta_key,
							'orderby' => $homeland_sold_order_value, 
