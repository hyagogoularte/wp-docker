...
<div class="row grid-cols agent-grid-sidebar post-bottom-2em clearfix">
	<?php
	  ...
	  if( !empty( $homeland_agents->results) ) :
		  foreach( $homeland_agents->results as $homeland_user ) :
		    global $wpdb;
				...
				$homeland_agent_id = $homeland_post_author;
					...
					<div class="agent-list">
						<a href="<?php echo esc_url( $homeland_agent_url ); ?>">
							<?php if( !empty( $homeland_custom_avatar ) ) : ?>
								<img src="<?php echo esc_url( $homeland_custom_avatar ); ?>" srcset="<?php echo esc_url( $homeland_custom_avatar ); ?> 600w" sizes="(max-width: 568px) 100vw, (max-width: 736px) 90vw, (max-width: 768px) 50vw, (max-width: 1024px) 30vw, 110px">
							<?php else : ?> 
								<?php echo get_avatar( $homeland_agent_id, 600 ); ?>
							<?php endif; ?>
						</a>
						<h4>
							<a href="<?php echo esc_url( $homeland_agent_url ); ?>">
