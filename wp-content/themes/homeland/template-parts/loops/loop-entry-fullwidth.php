...
<article id="post-<?php the_ID(); ?>" <?php sanitize_html_class( post_class( 'post-col-12 blist post-bottom' ) ); ?>>
	<div class="blog-mask">
		<?php 
			if ( post_password_required() ) :
				echo "<div class='password-protect-thumb password-blog'><i class='fas fa-lock fa-2x'></i></div>";
			else : ?>
